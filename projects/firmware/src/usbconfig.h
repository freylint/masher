 ...
 * pair. See the file USBID-License.txt for details.
 */
#define USB_CFG_DEVICE_NAME 'H', 'I', 'D', 'K', 'e', 'y', 's'
#define USB_CFG_DEVICE_NAME_LEN 7
/* Same as above for the device name. If you don't want a device name,
 * undefine the macros. See the file USBID-License.txt before you assign a
 * name.
 */
...
#define USB_CFG_DEVICE_CLASS \
    0 /* specify the class at the interface level \
	   */
